...
PROPORTIONAL_FONT_FAMILY = ("Arial", "Sans", "Arial")
...
def buttonbox(msg="",title=" "
    ...
    boxRoot.protocol('WM_DELETE_WINDOW', x_button_function)
    boxRoot.title(title)
    boxRoot.iconname('Dialog')
    boxRoot.geometry(rootWindowPosition)
    boxRoot.minsize(400, 100)
    boxRoot.resizable(0,0)
...
#Warning box
def warningbox(msg=""):
    winmod.sound_thread("SystemHand")
    return buttonbox(msg, choices=["OK"], image="LIP Source Files/warning.gif")

def messagebox(msg="", title="", image=None):
    return buttonbox(msg, choices=["OK"], image=image)
...
def aboutlipgui():
    """
    shows the lipgui revision history
    """
    codebox("About LIP GUI\n"+egversion,"LIP GUI",LIPGUI_ABOUT_INFORMATION)
    return None
